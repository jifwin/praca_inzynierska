...
public class DNSFrame extends ProtocolFrame {
    ...
    public void compileFrame() {
        ...
        //List<FrameField> frameFieldList = Arrays.asList(id,qr,opcode,aa,tc,rd,ra,z,rcode,qdcount,ancount,nscount,arcount,qname);
    ...
    public DNSFrame(String domain) { //request frame
        ...
        //qnameBytes = new byte[domain.length() + domainParts];
